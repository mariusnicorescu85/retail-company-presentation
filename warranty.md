...
A modern, user-friendly warranty registration platform built with Next.js that streamlines the product warranty registration process for customers.
...
- 🔄 Automated workflow with n8n webhook
- ⚡ Fast and efficient Next.js 15 architecture
...
### 2. Purchase Information Tracking
...
- **Mandatory receipt upload** for warranty validation
...
- Professional success state design
...
```
User Input → Client Validation → API Route → Cloudinary Upload → n8n Webhook → Success Response
```

### Key Components

1. **Client-Side Form (`app/page.tsx`)**
...
2. **API Route (`app/api/warranty-register/route.ts`)**
   - FormData parsing
...
- Organized folder structure (`warranty-receipts/`)
- Unique file naming for collision prevention
...
- **Color Scheme**: Blue gradient theme (#2563EB to #4F46E5)
...
- **TypeScript**: 5.8.3
- **File Upload**: Cloudinary v1.41.3
- **Form Handling**: Formidable v3.5.4

---

## Conclusion

A production-ready warranty registration system that combines:
